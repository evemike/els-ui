...
const tipBase = (option, appContext) => {
  elementPlus.ElMessage(option, appContext);
};
...
const elemTip = (info) => {
  ...
  if (typeof info === "string") {
    infoElem = info.split("/br").map((s) => ({ tag: elementPlus.ElAlert, closable: false, type: "info", title: s }));
  } else {
    infoElem = [info];
  }
  return {
    tag: elementPlus.ElPopover,
    ...
    cls: [
      {
        tag: elementPlus.ElButton,
        slot: "reference",
        class: "els-form--tip-button",
        link: true,
        icon: iconsVue.InfoFilled
      },
      ...infoElem
    ]
  };
...
exports.elemTip = elemTip;
exports.tip = tip;
exports.tipBase = tipBase;
exports.tipError = tipError;
exports.tipInfo = tipInfo;
exports.tipSuccess = tipSuccess;
exports.tipWarning = tipWarning;
