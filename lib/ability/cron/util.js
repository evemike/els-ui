...
const DER = { tag: elementPlus.ElRadio, prop: "type" };
const DES = { tag: elementPlus.ElSelect, elFormItem: false };
const DEIN = {
  tag: elementPlus.ElInputNumber,
...
const DECBG = { tag: elementPlus.ElCheckboxGroup, class: "_item _checkbox-group" };
const DECB = { tag: elementPlus.ElCheckbox };
...
const toData = (v, i) => {
  ...
  const [all, ...vals] = i == 9 ? [""].concat(lodash.uniq(v.split(","))) : reg.exec(v) || [];
...
const layoutData = lodash.fromPairs(LAYOUT);
const validator = (v) => {
...
const DETP = { tag: elementPlus.ElTabPane };
const DETAB = { tag: elementPlus.ElTabs, type: "border-card" };
...
exports.CRON_ATTR_NAMES = CRON_ATTR_NAMES;
exports.CRON_REGS = CRON_REGS;
exports.CRON_TEMP = CRON_TEMP;
exports.LAYOUT = LAYOUT;
exports.check = check;
exports.createCronData = createCronData;
exports.createCronText = createCronText;
